...
const Header = () => {
  ...
  return (
    <header className="h-[8svh] text-2xl font-bold lg:hidden w-full justify-between flex px-4 py-6 ">
      BizAug
      <button onClick={() => setOpen(true)}>
        <MenuIcon />
      </button>
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent side={"right"} className="p-4 py-16 bg-black">
          <div className="justify-between flex flex-col h-[92svh] text-white">
            <div>
